        ...
        <div className="flex items-start">
          ...
          <div className="ml-3">
            ...
            <div className="mt-2 text-sm text-amber-700">
              <p>
                Category management features are currently disabled because the backend GraphQL schema doesn't include the necessary mutations yet. 
                Please contact your development team to implement the category and topic management API endpoints.
              </p>
            </div>
          </div>
        </div>
